...
// Adjust the sprite position to align with the body
        ...
        redBirdDef.position.set(2.6f, 1.7f);

        CircleShape redBirdShape = new CircleShape();
        redBirdShape.setRadius(0.2f);
        ...
        redBirdSprite.setSize(0.4f, 0.4f);
        ...
        addPig("small_pig.png", new Vector2(12f, 3.1f), 0.15f, 1.0f);
