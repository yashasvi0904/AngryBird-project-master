...
public class Game_menu implements Screen {
    private static final float BUTTON_ANIMATION_DURATION = 3.0f;
    ...
    public void render(float delta) {
        ...
        if (buttonsVisible) {
            ...
            if (buttonAnimationTime >= BUTTON_ANIMATION_DURATION) {
